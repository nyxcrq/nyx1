...
export default function Home() {
  return (
    ...
    <>
      <Navber /> <section className="bg-light py-3 py-md-5 py-xl-8">
                ...
                <div className="col-12 col-xl-11">
                  ...
                  <div className="d-flex mb-5">
                    ...
                    <div>
                      ...
                      <address className="mb-0 text-secondary">hehehehehe</address>
                    </div>
                  </div>
                    ...
                    <div className="col-12 col-sm-6">
                      <div className="d-flex mb-5 mb-sm-0">
                        ...
                        <div>
                          ...
                          <p className="mb-0">
                            <a className="link-secondary text-decoration-none" href="tel:+15057922430">000-000-0000</a>
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-12 col-sm-6">
                      <div className="d-flex mb-0">
                        ...
                        <div>
                          ...
                          <p className="mb-0">
                            <a className="link-secondary text-decoration-none" href="mailto:contact@bootbrains.com">animeT@gmail.com</a>
                          </p>
                        </div>
                      </div>
                    </div>
